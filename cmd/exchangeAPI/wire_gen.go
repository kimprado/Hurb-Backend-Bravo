...
func initializeApp(path string) (*app.ExchangeApp, error) {
	...
	ratesFinderCache := currencyexchange.NewRatesFinderCache(ratesFinderService, loggerRates)
	...
	calculatorController := currencyexchange.NewCalculatorController(currencyManagerProxy, ratesFinderProxy, loggerCalculator)
